...
function initSearch() {
  ...
  request.open('GET', '/mmtt-preview/mmtt-320/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/mmtt-preview/mmtt-320/assets/css/just-the-docs-' + theme + '.css');
}
